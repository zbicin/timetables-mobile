...
var Card = exports.Card = function () {
    ...
    var build = function build(boardData) {
...
var _geolocation = __webpack_require__(127);
...
var getNearbyStopsIds = function getNearbyStopsIds(latitude, longitude) {
    var url = 'http://tablice-zbicin.rhcloud.com/api/getNearestStops?latitude=' + latitude + '&longitude=' + longitude;
    return http.get(url).then(function (response) {
        var stops = JSON.parse(response.responseText);
        var stopsIds = stops.map(function (stop) {
            return stop.id;
        });
...
var _reset = __webpack_require__(125);
...
var _timetables = __webpack_require__(123);
...
var renderBoards = function renderBoards(boards) {
    ...
    boards.map(card.build).forEach(function (card) {
...
var onDeviceReady = function onDeviceReady() {
    ...
    timetables.fetchNearbyTimetables().then(function (boards) {
        renderBoards(boards);
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(132));
