...
var _debugConsole = __webpack_require__(97);
...
var _ui = __webpack_require__(94);
...
var _geolocation = __webpack_require__(142);
...
var _geolocation2 = __webpack_require__(64);

Object.keys(_geolocation2).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _geolocation2[key];
    }
  });
});
...
var _timetables = __webpack_require__(143);

Object.keys(_timetables).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
...
var _timetables2 = __webpack_require__(144);

Object.keys(_timetables2).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _timetables2[key];
    }
  });
});
...
(function (Events) {
    Events["DevicePause"] = "DevicePause";
    Events["DeviceReady"] = "DeviceReady";
    Events["DeviceResume"] = "DeviceResume";
    Events["InfoClick"] = "InfoClick";
    Events["RefreshClick"] = "RefreshClick";
    Events["RetryClick"] = "RetryClick";
})(Events || (exports.Events = Events = {}));
var cordova = window.cordova;

var UI = exports.UI = function (_Emitter) {
    _inherits(UI, _Emitter);
    ...
    function UI() {
        ...
        _this.menuInfoElement = _dom.DOMHelper.$('#menu-info');
        _this.menuInfoElement.addEventListener('click', function (e) {
            return _this.dispatchEvent(Events.InfoClick);
        });
        _this.menuRefreshElement = _dom.DOMHelper.$('#menu-refresh');
        _this.menuRefreshElement.addEventListener('click', function (e) {
            return _this.dispatchEvent(Events.RefreshClick);
        });
        _this.menuTitle = _dom.DOMHelper.$('#menu-title');
        _this.cardList = new _index.CardList();
        _this.debugConsole = new _debugConsole.DebugConsole();
        _this.splash = new _index2.Splash(_this.debugConsole);
        _this.splash.retryButton.addEventListener('click', function (e) {
...
var stylesInDom = {},
	...
	fixUrls = __webpack_require__(340);
...
var _http = __webpack_require__(139);
...
var app = new _app.App(_index.DummyTimetables, _ui.UI);
...
var _geolocation = __webpack_require__(64);
    ...
    _createClass(DummyTimetables, [{
        ...
        value: function fetchNearbyTimetables() {
            ...
            for (var i = 0; i < limit; i++) {
                var dummyBoard = this.generateDummyBoard(i);
        ...
        key: 'generateDummyBoard',
        value: function generateDummyBoard(index) {
            var now = new Date();
            var formattedNow = this.formatTime(now);
            var departures = [];
...
var _cardList = __webpack_require__(145);
...
var ctx            = __webpack_require__(23)
  ...
  , aFunction      = __webpack_require__(12)
  , forOf          = __webpack_require__(35)
  , isIterable     = __webpack_require__(123)
  , $iterCreate    = __webpack_require__(57)
  , step           = __webpack_require__(74)
  , isObject       = __webpack_require__(4)
  , toIObject      = __webpack_require__(11)
...
$export($export.P + $export.F, 'Function', {part: __webpack_require__(80)});
...
var $export = __webpack_require__(0)
  , define  = __webpack_require__(112);
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(81)(/[&<>"']/g, {
  '&': '&amp;',
  '<': '&lt;',
  '>': '&gt;',
  '"': '&quot;',
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(81)(/&(?:amp|lt|gt|quot|apos);/g, {
  '&amp;':  '&',
  '&lt;':   '<',
  '&gt;':   '>',
  '&quot;': '"',
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(344), __webpack_require__(338)))
